  ...
  return (
    <div>
      <section className="p-10 flex justify-center items-center">
        ...
        <div
          style={{ width: '30%' }}
          className="pr-20 flex justify-center items-center"
        >
          <Image
      ...
      <section className="p-10 flex bg-gray-300">
        <div style={{ width: '70%' }} className="pr-10 flex flex-col">
          ...
          <div className="flex flex-wrap gap-10 mt-10 justify-center">
            <div className="w-80 bg-white rounded-lg shadow-md hover:shadow-2xl transition-shadow duration-300 p-6 flex flex-col items-center ">
              ...
              ></Image>
              <p className="text-2xl font-bold mt-4 mb-2">Lucas A. de Lima</p>
              <a
            ...
            <div className="w-80 bg-white rounded-lg shadow-md hover:shadow-2xl transition-shadow duration-300 p-6 flex flex-col items-center ">
              <Image
                ...
                className="rounded-md"
              ></Image>
              <p className="text-2xl font-bold mt-4 mb-2">Julia de A. Pires</p>
            ...
            <div className="w-80 bg-white rounded-lg shadow-md hover:shadow-2xl transition-shadow duration-300 p-6 flex flex-col items-center ">
              <Image
                ...
                className="rounded-md"
              ></Image>
              <p className="text-2xl font-bold mt-4 mb-2">Nuno M. M. Abilio</p>
              <a
                className="text-blue-500 hover:underline"
                href={
                  'https://www.linkedin.com/in/nuno-miguel-mendon%C3%A7a-abilio-7b390a304?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app'
                }
              >
                Linkedin
              </a>
            ...
            <div className="w-80 bg-white rounded-lg shadow-md hover:shadow-2xl transition-shadow duration-300 p-6 flex flex-col items-center ">
              ...
              <a
                className="text-blue-500 hover:underline"
                href={
                  'https://www.linkedin.com/in/sophia-freire-956652210?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=ios_app'
                }
              >
                Linkedin
              </a>
            ...
            <div className="w-80 bg-white rounded-lg shadow-md hover:shadow-2xl transition-shadow duration-300 p-6 flex flex-col items-center ">
              <Image
                ...
                className="rounded-md"
              ></Image>
              <p className="text-2xl font-bold mt-4 mb-2">Arthur H. da Silva</p>
              <a
                className="text-blue-500 hover:underline"
                href={
                  'https://www.linkedin.com/in/arthur-henrique-da-silva-536723269?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app'
                }
              >
                Linkedin
              </a>
            ...
            <div className="w-80 bg-white rounded-lg shadow-md hover:shadow-2xl transition-shadow duration-300 p-6 flex flex-col items-center ">
              ...
              <a
                className="text-blue-500 hover:underline"
                href={
                  'https://www.linkedin.com/in/giovana-da-silva-bulc%C3%A3o?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app'
                }
              >
                Linkedin
              </a>
            ...
            <div className="w-80 bg-white rounded-lg shadow-md hover:shadow-2xl transition-shadow duration-300 p-6 flex flex-col items-center ">
              ...
              <a
                className="text-blue-500 hover:underline"
                href={
                  'https://www.linkedin.com/in/cintia-da-silva-bulc%C3%A3o-66896836b?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app'
                }
              >
                Linkedin
              </a>
            ...
            <div className="w-80 bg-white rounded-lg shadow-md hover:shadow-2xl transition-shadow duration-300 p-6 flex flex-col items-center ">
              ...
              <a
                className="text-blue-500 hover:underline"
                href={
                  'https://www.linkedin.com/in/pedro-luiz-47565b231?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app'
                }
              >
                Linkedin
              </a>
            ...
            <div className="w-80 bg-white rounded-lg shadow-md hover:shadow-2xl transition-shadow duration-300 p-6 flex flex-col items-center ">
              ...
              <a
                className="text-blue-500 hover:underline"
                href={
                  'https://www.linkedin.com/in/bernardo-oliveira-b53666206?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app'
                }
              >
                Linkedin
              </a>
        ...
        <div style={{ width: '30%' }} className="pr-20">
          <p className="text-xl font-semibold text-black text-justify mt-10">
            O CACCOM é composto por 7 diretorias, cada uma com suas próprias
            atribuições e tarefas dentro da instituição.
          </p>
          <p className="text-xl font-semibold text-black text-center mt-10">
            Compõe a gestão atual do{' '}
            <span className="text-red border-b-2 border-red">CACCOM</span>
          </p>
          <ul className="list-none list-inside">
            ...
            <li className="rounded-lg p-4 mt-5 bg-red gap-2 text-white">
              <p className="text-center">
                ...
                <span className="font-bold text-xl ">
                  {' '}
                  Diretor de Mídias e Comunicações{' '}
                </span>
              </p>
            </li>
            <li className="rounded-lg p-4 mt-5 bg-red gap-2 text-white">
        ...
        <div className="flex justify-around pt-10">
          <div style={{ width: '20%' }} className="flex flex-col gap-4 pr-10">
            ...
            <p className="flex text-xl items-end gap-2">
              ...
              <span className="font-bold"> Bloco C56 - Sala 005 </span>
            </p>
          </div>
          <div
            style={{ width: '80%' }}
            className="rounded-lg border-4 border-red"
          >
            <Map />
          </div>
        </div>
